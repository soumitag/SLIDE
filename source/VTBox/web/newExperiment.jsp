...
<body>
    ...
    <form name="fileInputForm" method ="get" action="">
            ...
            <tr>
                ...
                <td colspan="1">
                    <input type="checkbox" id="log2flag" name="log2flag" checked="checked"> Perform log base 2 transformation of the data</input>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="text-align: center">
                    <button class="dropbtn" id="EnterNewExperiment" title="Enter New Experiment" onclick="submitform(this.form);">Enter</button>                    
                </td>
            </tr>
