                        ...
                        if(session != null) {
                            ...
                            while (keys.hasMoreElements()){
                                ...
                                if (obj instanceof AnalysisContainer){
                                    AnalysisContainer analysis = (AnalysisContainer)obj;
                                    hasRunningOnes = true;
                    %>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <button class="dropbtn" id="openAnalysis" title="Go to Analysis" onclick="window.open('<%=base_url%>displayHome.jsp?analysis_name=<%=analysis.analysis_name%>&load_type=reopen')">Go To Analysis</button>
                                            <button class="dropbtn" id="stopAnalysis" title="Stop Analysis" onclick="">Stop</button>
                                        </td>
                                    </tr>
                    <%            
                                }
