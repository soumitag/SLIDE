        ...
        <table width="100%" height="99%" cellspacing="0" cellpadding="0" border="0" style="position: absolute; top: 0px; left: 0px"> 
            ...
            <tr>
                <td rowspan="3" align="top" valign="top" height="100%" style="border-style: solid; border-color: #E1E1E1">
                    <iframe name="selectionPanel" id="selectionPanel" src="selectionPanel.jsp?analysis_name=<%=analysis_name%>" marginwidth="0" height="100%" width="300" frameBorder="0" style="display: inline; position: relative; top: 0px; left: 0px"></iframe>
                </td>
