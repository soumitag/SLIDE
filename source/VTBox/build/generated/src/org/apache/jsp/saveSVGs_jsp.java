...
try {
    ...
    */
    ...
    String dendrogram_end = (d_end == null) ? "" : d_end + "";
      ...
      out.write("                \n");
      out.write("                if (document.getElementById('global_view_incl_search_tags').checked) {\n");
      out.write("                    gvi_search_tags = document.getElementById('global_view_incl_search_tags').value;\n");
      out.write("                }\n");
      out.write("                \n");
      out.write("                if (document.getElementById('global_view_incl_hist').checked) {\n");
      out.write("                    gvi_hist = document.getElementById('global_view_incl_hist').value;\n");
      out.write("                }\n");
      out.write("                \n");
      out.write("                if (document.getElementById('global_view_incl_dend') != null) {\n");
      out.write("                    if (document.getElementById('global_view_incl_dend').checked) {\n");
      out.write("                        gvi_dend = document.getElementById('global_view_incl_dend').value;\n");
      out.write("                    }\n");
      out.write("                } else {\n");
      ...
      out.write("                \n");
      out.write("                if (document.getElementById('dend_view_incl_search_tags').checked) {\n");
      out.write("                    gvi_search_tags = document.getElementById('dend_view_incl_search_tags').value;\n");
      out.write("                }\n");
      out.write("                \n");
      out.write("                if (document.getElementById('dend_view_incl_hist').checked) {\n");
      out.write("                    gvi_hist = document.getElementById('dend_view_incl_hist').value;\n");
      out.write("                }\n");
      out.write("                \n");
      out.write("                if (document.getElementById('dend_view_incl_dend') != null) {\n");
      out.write("                    if (document.getElementById('dend_view_incl_dend').checked) {\n");
      out.write("                        gvi_dend = document.getElementById('dend_view_incl_dend').value;\n");
      out.write("                    }\n");
      out.write("                } else {\n");
      out.write("                    gvi_dend = \"no\";\n");
      out.write("                }\n");
      ...
      out.write("                \n");
      out.write("                if (document.getElementById('detailed_view_incl_search_tags').checked) {\n");
      out.write("                    dvi_search_tags = document.getElementById('detailed_view_incl_search_tags').value;\n");
      out.write("                }\n");
      out.write("                \n");
      out.write("                if (document.getElementById('detailed_view_incl_hist').checked) {\n");
      out.write("                    dvi_hist = document.getElementById('detailed_view_incl_hist').value;\n");
      out.write("                }\n");
      out.write("                //alert( document.getElementById('detailed_view_start').value);\n");
      out.write("                dvi_start = document.getElementById('detailed_view_start').value;\n");
      out.write("                dvi_end = document.getElementById('detailed_view_end').value;\n");
      out.write("                //alert(\"2\");\n");
      out.write("                \n");
      ...
      out.print(analysis_name);
      out.write("&detailed_view_incl_search_tags=\" + dvi_search_tags + \"&detailed_view_incl_hist=\" + dvi_hist + \"&start=\" + dvi_start + \"&end=\" + dvi_end;\n");
 ...
 if (analysis.isTreeAvailable) { 
      ...
      out.write("            <h3>Dendrogram View</h3>\n");
      out.write("            <table>\n");
      out.write("                <tr>\n");
      out.write("                    <td width=\"35%\">\n");
      out.write("                        Include Search Tags\n");
