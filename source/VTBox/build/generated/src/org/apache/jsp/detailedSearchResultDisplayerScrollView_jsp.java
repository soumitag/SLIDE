...
public final class detailedSearchResultDisplayerScrollView_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try {
    ...
    double left_position = 0;
      ...
      out.write("        <script>\n");
      out.write("        \n");
      out.write("            function callDetailedInfoUpdater(eid) {\n");
      out.write("                parent.showDetailedInfo(eid);\n");
      out.write("            }\n");
      out.write("            \n");
      ...
      out.write("    <body>\n");
      out.write("    \n");
      out.write("        <svg id='search_svg' height=\"");
